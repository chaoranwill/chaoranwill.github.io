(function($){
  ...
  function write(){
    ...
    + "       <img  class=\"qrcode-img qrCode_0\" id=\"qrCode_0\" src=\"//res.zgboke.com/wp-content/themes/begin/img/wechat.jpg\" />"
    + "      </div>"
    ...
    + "       <img  class=\"qrcode-img qrCode_1\" id=\"qrCode_1\" src=\"//res.zgboke.com/wp-content/themes/begin/img/qqqb.png\" />"
    + "      </div>"
    + "      <p class=\"qrcode-tip\">打赏</p>"
    + "     </div>"
    + "     <div class=\"qrcode-img qrCode_2\" id=\"qrCode_2\">"
    + "      <div class=\"qrcode-border box-size\" style=\"border: 9.02px solid rgb(235, 95, 1\">"
    + "       <img  class=\"qrcode-img qrCode_2\" id=\"qrCode_2\" src=\"//res.zgboke.com/wp-content/themes/begin/img/zfb.png\" />"
    + "      </div>"
    + "      <p class=\"qrcode-tip\">打赏</p>"
    + "     </div>"
